...
const longestString = (arr) => {
  ...
  if(arr.length===0){
    ...
    const i= arr.indexOf( arr.reduce(
      function (a, b) {
...
------------------------------------------------------------------------------------------------ */
let words2 = ['things', 'apple (:)', ':)banana', 'missing that thing', 'cant:)aloupe'];
...
console.log(findHappiness(words2));
