...
function returnTen(str){
  ...
  let returnedArray = newArr.splice(newArr.length - 10);
...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
  const regex = /[uaeio]+/mg;

  const vowelsArr = arr.filter(element=>{
